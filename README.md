[![Build Status](https://travis-ci.com/Akhil-Anga/ecommerce-spring-reactjs.svg?branch=main)](https://github.com/Akhil-Anga/ecommerce-spring-reactjs)
[![codecov](https://codecov.io/gh/Akhil-Anga/ecommerce-spring-reactjs/branch/main/graph/badge.svg)](https://github.com/Akhil-Anga/ecommerce-spring-reactjs)
...
15. Add reCAPTCHA key to the application.properties file: [link](https://i.ibb.co/nDTP8H5/prop-recaptcha.png) and to [link](https://github.com/Akhil-Anga/ecommerce-spring-reactjs/blob/main/frontend/src/pages/Registration/Registration.tsx#L134)
...
This project is maintained by Venkata Sai Akhil Anga. Venkata is a Full Stack Developer with over 5 years of experience in designing and delivering scalable enterprise applications using Java, Spring Boot, and React.js. He specializes in cloud-native architectures and high-performance web solutions.
